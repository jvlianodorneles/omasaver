...
BarWidget {
  ...
  readonly property var fontPresets: [
    { id: "delta_corps_priest_1", name: "⚡ Omarchy (Delta)", desc: "Signature Omarchy font" },
    { id: "slant", name: "Slant", desc: "Classic modern italics" },
    { id: "standard", name: "Standard", desc: "Clean terminal FIGlet" },
    { id: "banner", name: "Banner", desc: "Large bold blocky" },
    { id: "block", name: "Block", desc: "Heavy geometric" },
    { id: "doom", name: "Doom", desc: "Gaming iconic font" },
    { id: "starwars", name: "Star Wars", desc: "Sci-fi aesthetic" }
  ]
  ...
  IpcHandler {
    ...
    function openStudio(): void { root.openTui() }
  ...
  PopupCard {
    ...
    Column {
      ...
      Row {
        ...
        Button {
          iconText: "\udb80\udf93"
          tooltipText: "Launch Full Terminal TUI"
          anchors.verticalCenter: parent.verticalCenter
