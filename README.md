...
> **A native Omarchy 4 widget studio for live ASCII art generation, screensaver management (`ttfx`), and branding customization.**
...
- **🚀 Top Bar Widget:** Quick-access widget on your Omarchy bar (`󱄄 omasaver`).
